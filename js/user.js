const credentials = {
    ...
    vonadi: { password: 'Ns8%Kw3@', subjects: [{ name: 'history', grade: 7 }] },
    januni: { password: 'Hj2&Yx7%', subjects: [{ name: 'history', grade: 7 }] },
    radheesha: { password: 'Qp9@Gs4&', subjects: [{ name: 'history', grade: 7 }] },
    ...
    sadew: { password: 'Ft9#Vw2&', subjects: [{ name: 'history', grade: 7 },{ name: 'geography', grade: 7 },{ name: 'civic', grade: 7 }] },    
    samindya: { password: 'Rp4@Nh7%', subjects: [{ name: 'geography', grade: 7 },{ name: 'history', grade: 7 }] },
    kulsum: { password: 'Ts2&Yx8#', subjects: [{ name: 'geography', grade: 7 },{ name: 'history', grade: 7 },{ name: 'civic', grade: 7 }] },
    ...
    navodya: { password: 'Xy8#Bu3@', subjects: [{ name: 'history', grade: 7 }] },
    ...
    sadil: { password: 'Tj2@Vr7&', subjects: [{ name: 'history', grade: 8 },{ name: 'geography', grade: 8 },{ name: 'civic', grade: 8 }] },
    damindu: { password: 'Pd3#Qv9&', subjects: [{ name: 'history', grade: 8 },{ name: 'geography', grade: 8 },{ name: 'civic', grade: 8 }] },
    ...
    eshini: { password: 'Zx9@Pu4&', subjects: [{ name: 'history', grade: 8 },{ name: 'geography', grade: 8 },{ name: 'civic', grade: 8}] },
    ...
    reema: { password: 'Dr1%Lw6@', subjects: [{ name: 'history', grade: 8 },{ name: 'geography', grade: 8 },{ name: 'civic', grade: 8}] },
    ...
    lahiru: { password: 'Ne7&Lw2%', subjects: [{ name: 'history', grade: 8 },{ name: 'geography', grade: 8 }] },
    ...
    senula: { password: 'Be8&Ns3%', subjects: [{ name: 'history', grade: 9 },{ name: 'geography', grade: 9 },{ name: 'civic', grade: 9}] },
    ...
    hesaka: { password: 'Vx9#Lu4&', subjects: [{ name: 'history', grade: 10 }] },
